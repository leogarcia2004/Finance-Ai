...
export const addTransaction = async (params: AddTransactionParams) => { // params são os dados do meu formulário
    // Prisma.TransactionCreateInput da todos os campos necessários para reiazar a criação de uma transação.

    addTransactionSchema.parse(params); // validando os dados do formulário
    ...
    const transaction = await db.transaction.create({
        data: {...params, userId}, // passando todos os dados do formulário e o id do usuário
    });
